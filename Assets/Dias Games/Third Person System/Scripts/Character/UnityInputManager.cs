...
namespace DiasGames.ThirdPersonSystem
{
    ...
    {
        // Camera reference
        [Tooltip("Camera used in the scene")]
        [SerializeField]
        ...
        [Space()]
        [SerializeField]
        private string m_JumpInputName = "Jump";
        ...
        [Space()]
        [SerializeField]
        private string m_RollInputName = "Roll";

        [Space()]
        [SerializeField]
        private string m_DropInputName = "Drop";

        [Space()]
        [SerializeField]
        private string m_CrouchInputName = "Crouch";

        [Space()]
        [SerializeField]
        private string m_CrawlInputName = "Crawl";

        [Space()]
        [SerializeField]
        private string m_ZoomInputName = "Zoom";

        [Space()]
        [SerializeField]
        private string m_InteractInputName = "Interact";

        [Space()]
        [SerializeField]
        private string m_ToggleWeaponInputName = "Toggle";

        [Space()]
        [SerializeField]
        private string m_RightWeaponInputName = "RightWeapon";

        [Space()]
        [SerializeField]
        private string m_LeftWeaponInputName = "LeftWeapon";

        [Space()]
        [SerializeField]
        private string m_FireInputName = "Fire";
        ...
        [Space()]
        [SerializeField]
        private string m_ExtraAction01 = string.Empty;

        [Space()]
        [SerializeField]
        private string m_ExtraAction02 = string.Empty;

        [Space()]
        [SerializeField]
        private string m_ExtraAction03 = string.Empty;
