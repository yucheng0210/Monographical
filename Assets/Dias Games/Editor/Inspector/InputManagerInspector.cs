...
namespace DiasGames.ThirdPersonSystem
{
    ...
    public class InputManagerInspector : BaseInspector
    {
        ...
        protected override void OnEnable()
        {
            ...
            cursor = serializedObject.FindProperty("m_CursorVisible");
        }
        ...
        private void DrawAbilitiesInput()
        {
            ...
            if (property.NextVisible(true))
            {
                do
                {
                    if (property.name.Contains("m_Script") || property.name.Contains("m_Camera") || property.name.Contains("m_CursorVisible"))
                        continue;
