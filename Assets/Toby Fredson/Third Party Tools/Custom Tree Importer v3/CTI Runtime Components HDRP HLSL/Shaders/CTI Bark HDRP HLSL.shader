    ...
    SubShader
    {
        ...
        // We need isFontFace when using double sided
            ...
            //-------------------------------------------------------------------------------------
                    ...
                    float _NormalStrength; float _SmoothnessMin; float _SmoothnessMax;
            ...
            //-------------------------------------------------------------------------------------
                ...
                // Pixel Graph Evaluation
                    SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
                    {
                        ...
                        float4 albedoSmoothness = SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, IN.uv0.xy);
                        float4 normalOcclusion = SAMPLE_TEXTURE2D(_BumpSpecAOMap, sampler_BumpSpecAOMap, IN.uv0.xy);
                        float3 normal;
                        normal.xy = normalOcclusion.ag * 2.0 - 1.0;
                        ...
                        surface.Smoothness = lerp(_SmoothnessMin, _SmoothnessMax, albedoSmoothness.a);
                        surface.Occlusion = normalOcclusion.b * IN.VertexColor.a;
                        surface.Alpha = 1;
                        return surface;
                    }
            ...
            //-------------------------------------------------------------------------------------
                ...
                // Pixel Graph Evaluation
                    SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
                    {
                        ...
                        surface.Smoothness = lerp(_SmoothnessMin, _SmoothnessMax, _SampleTexture2D_1060DFD5_A_7);
                        surface.Alpha = 1;
                        return surface;
                    }
