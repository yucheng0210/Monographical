...
Shader "Tobyfredson/Waterfall Base_HDRP"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord7 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner8 = ( ( _TimeParameters.x ) * _Speed + texCoord7);
				
				float2 uv_Foam_Alpha = packedInput.ase_texcoord5.xy * _Foam_Alpha_ST.xy + _Foam_Alpha_ST.zw;
				
				surfaceDescription.Albedo = ( _Color * tex2D( _FoamTexture_Albedo, panner8 ) ).rgb;
				...
				surfaceDescription.Alpha = tex2D( _Foam_Alpha, uv_Foam_Alpha ).a;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 texCoord7 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner8 = ( ( _TimeParameters.x ) * _Speed + texCoord7);
				
				float2 uv_Foam_Alpha = packedInput.ase_texcoord2.xy * _Foam_Alpha_ST.xy + _Foam_Alpha_ST.zw;
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_Foam_Alpha = packedInput.ase_texcoord1.xy * _Foam_Alpha_ST.xy + _Foam_Alpha_ST.zw;
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_Foam_Alpha = packedInput.ase_texcoord3.xy * _Foam_Alpha_ST.xy + _Foam_Alpha_ST.zw;
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 texCoord7 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner8 = ( ( _TimeParameters.x ) * _Speed + texCoord7);
				
				float2 uv_Foam_Alpha = packedInput.ase_texcoord7.xy * _Foam_Alpha_ST.xy + _Foam_Alpha_ST.zw;
...
/*ASEBEGIN
Version=18933
144;617;1906;636;1532.106;269.4655;1;True;True
...
Node;AmplifyShaderEditor.ColorNode;24;-548.0491,-256.7796;Inherit;False;Property;_Color;Color;3;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;37;-212.3057,98.59406;Inherit;False;Constant;_Float0;Float 0;5;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
WireConnection;26;4;37;0
WireConnection;26;7;37;0
WireConnection;26;9;23;4
ASEEND*/
//CHKSM=668A19B5899D15AEA559465459DCB2F96EF4348F