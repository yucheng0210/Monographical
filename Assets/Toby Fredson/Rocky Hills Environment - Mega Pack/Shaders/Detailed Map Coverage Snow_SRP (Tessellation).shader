...
Shader "Tobyfredson/Detailed Map Coverage Snow_HDRP (Tessellation)"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float4 lerpResult356 = lerp( float4( 0,0,0,0 ) , ( CoverageDisplacement353 * float4( inputMesh.normalOS , 0.0 ) ) , temp_output_149_0);
						...
						)
			{
				...
				float temp_output_149_0 = saturate( ( normalWS.y * _CoverageAmount ) );
				...
				float2 texCoord270 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord268 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0.01 );
				float2 appendResult269 = (float2(0.0 , _BlurSize));
				float2 texCoord273 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0.01,0 );
				float2 appendResult272 = (float2(_BlurSize , 0.0));
				float2 texCoord274 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0.01,0.01 );
				...
				float2 uv_SparkleNoiseMap = packedInput.ase_texcoord5.xy * _SparkleNoiseMap_ST.xy + _SparkleNoiseMap_ST.zw;
				...
				float clampResult481 = clamp( pow( abs( ( distance( ase_worldPos , _WorldSpaceCameraPos ) / _TransitionDistance ) ) , _TransitionFalloff ) , 0.0 , 1.0 );
				...
				surfaceDescription.Emission = ( temp_output_149_0 * Sparkles469 ).rgb;
				surfaceDescription.Smoothness = lerpResult180;
				surfaceDescription.Occlusion = pow( staticSwitch424 , _Float5 );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float3 lerpResult246 = lerp( NormalMapMain249 , UnpackNormalScale( tex2D( _DetailNormal, TileUVs2231 ), 1.0f ) , tex2DNode221.a);
				float3 DetailNormalMap248 = lerpResult246;
				float2 texCoord270 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord268 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0.01 );
				float2 appendResult269 = (float2(0.0 , _BlurSize));
				float2 texCoord273 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0.01,0 );
				float2 appendResult272 = (float2(_BlurSize , 0.0));
				float2 texCoord274 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0.01,0.01 );
				float2 appendResult276 = (float2(_BlurSize , _BlurSize));
				float3 lerpResult300 = lerp( NormalMapMain249 , ( ( ( ( UnpackNormalScale( tex2D( _NormalMap, texCoord270 ), 1.0 ) * 0.4 ) + ( UnpackNormalScale( tex2D( _NormalMap, ( texCoord268 + appendResult269 ) ), 1.0 ) * 0.2 ) ) + ( UnpackNormalScale( tex2D( _NormalMap, ( texCoord273 + appendResult272 ) ), 1.0 ) * 0.2 ) ) + ( UnpackNormalScale( tex2D( _NormalMap, ( texCoord274 + appendResult276 ) ), 1.0 ) * 0.2 ) ) , step( 0.5 , _ToggleBlur ));
				float3 NormalMapBlure301 = lerpResult300;
				float3 lerpResult185 = lerp( lerpResult152 , BlendNormal( NormalMapBlure301 , TriplanarNormal259 ) , temp_output_174_0);
				...
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float2 uv_SparkleNoiseMap = packedInput.ase_texcoord2.xy * _SparkleNoiseMap_ST.xy + _SparkleNoiseMap_ST.zw;
				float2 temp_output_438_0 = ( uv_SparkleNoiseMap * _Frequency );
				float mulTime439 = _TimeParameters.x * _Speed;
				float smoothstepResult459 = smoothstep( _Threshold , ( _Threshold + _Range ) , ( tex2D( _SparkleNoiseMap, ( ( (ase_screenPosNorm).xy * _ScreenContribution ) + temp_output_438_0 + mulTime439 ) ).g * tex2D( _SparkleNoiseMap, ( ( temp_output_438_0 * 1.1 ) + -mulTime439 ) ).g ));
		...
		Pass
		{
					...
					)
			{
				...
				float temp_output_149_0 = saturate( ( normalWS.y * _CoverageAmount ) );
				float3 lerpResult152 = lerp( NormalMapMain249 , TriplanarNormal259 , temp_output_149_0);
				float2 texCoord270 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord268 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0.01 );
				float2 appendResult269 = (float2(0.0 , _BlurSize));
				float2 texCoord273 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0.01,0 );
				float2 appendResult272 = (float2(_BlurSize , 0.0));
				float2 texCoord274 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0.01,0.01 );
				float2 appendResult276 = (float2(_BlurSize , _BlurSize));
				float3 lerpResult300 = lerp( NormalMapMain249 , ( ( ( ( UnpackNormalScale( tex2D( _NormalMap, texCoord270 ), 1.0 ) * 0.4 ) + ( UnpackNormalScale( tex2D( _NormalMap, ( texCoord268 + appendResult269 ) ), 1.0 ) * 0.2 ) ) + ( UnpackNormalScale( tex2D( _NormalMap, ( texCoord273 + appendResult272 ) ), 1.0 ) * 0.2 ) ) + ( UnpackNormalScale( tex2D( _NormalMap, ( texCoord274 + appendResult276 ) ), 1.0 ) * 0.2 ) ) , step( 0.5 , _ToggleBlur ));
				float3 NormalMapBlure301 = lerpResult300;
				float3 tanToWorld0 = float3( tangentWS.xyz.x, ase_worldBitangent.x, normalWS.x );
		...
		Pass
		{
						...
						)
			{
				...
				float3 lerpResult246 = lerp( NormalMapMain249 , UnpackNormalScale( tex2D( _DetailNormal, TileUVs2231 ), 1.0f ) , tex2DNode221.a);
				float3 DetailNormalMap248 = lerpResult246;
				float2 texCoord270 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord268 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0.01 );
				float2 appendResult269 = (float2(0.0 , _BlurSize));
				float2 texCoord273 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0.01,0 );
				float2 appendResult272 = (float2(_BlurSize , 0.0));
				float2 texCoord274 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0.01,0.01 );
				float2 appendResult276 = (float2(_BlurSize , _BlurSize));
				float3 lerpResult300 = lerp( NormalMapMain249 , ( ( ( ( UnpackNormalScale( tex2D( _NormalMap, texCoord270 ), 1.0 ) * 0.4 ) + ( UnpackNormalScale( tex2D( _NormalMap, ( texCoord268 + appendResult269 ) ), 1.0 ) * 0.2 ) ) + ( UnpackNormalScale( tex2D( _NormalMap, ( texCoord273 + appendResult272 ) ), 1.0 ) * 0.2 ) ) + ( UnpackNormalScale( tex2D( _NormalMap, ( texCoord274 + appendResult276 ) ), 1.0 ) * 0.2 ) ) , step( 0.5 , _ToggleBlur ));
				float3 NormalMapBlure301 = lerpResult300;
				float3 lerpResult185 = lerp( lerpResult152 , BlendNormal( NormalMapBlure301 , TriplanarNormal259 ) , temp_output_174_0);
				...
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float2 uv_SparkleNoiseMap = packedInput.ase_texcoord7.xy * _SparkleNoiseMap_ST.xy + _SparkleNoiseMap_ST.zw;
				float2 temp_output_438_0 = ( uv_SparkleNoiseMap * _Frequency );
				float mulTime439 = _TimeParameters.x * _Speed;
				float smoothstepResult459 = smoothstep( _Threshold , ( _Threshold + _Range ) , ( tex2D( _SparkleNoiseMap, ( ( (ase_screenPosNorm).xy * _ScreenContribution ) + temp_output_438_0 + mulTime439 ) ).g * tex2D( _SparkleNoiseMap, ( ( temp_output_438_0 * 1.1 ) + -mulTime439 ) ).g ));
				float fresnelNdotV457 = dot( normalWS, V );
...
/*ASEBEGIN
Version=18933
66;80;1906;728;4048.864;114.2149;2.450398;True;True
...
Node;AmplifyShaderEditor.CommentaryNode;472;-4235.204,2135.312;Inherit;False;1968.271;500.7608;Distance Control;10;482;481;480;478;477;476;475;474;473;497;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;244;-166.2375,1663.948;Float;False;Property;_Float6;Smoothness Coverage;20;0;Create;False;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;155;-575.6763,1439.162;Float;True;Property;_CoverageAlbedo;Coverage Albedo;16;2;[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.SamplerNode;223;-1206.894,245.2508;Inherit;True;Property;_Albedo;Albedo;0;2;[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TexturePropertyNode;351;-582.6713,2249.06;Float;True;Property;_CoverageDisplacement;Coverage Displacement;18;2;[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.SamplerNode;156;-1189.734,915.2295;Inherit;True;Property;_MetallicAoGloss;Metallic/Ao/Gloss;3;2;[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StaticSwitch;424;584.1711,1268.177;Inherit;False;Property;_ToggleSnowAo;Toggle Snow Ao;7;0;Create;True;0;0;0;False;0;False;0;0;0;True;;ToggleOff;2;Key0;Key1;Create;False;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;158;561.2178,1371.767;Float;False;Property;_Float5;Ambient Occlusion;6;0;Create;False;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;166;412.5836,974.983;Float;False;Property;_Float3;Metallic;5;0;Create;False;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;346;895.7144,1771.791;Float;False;Property;_Displacement;Displacement;19;0;Create;True;0;0;0;False;0;False;0;0.3;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.AbsOpNode;496;392.1584,1274.932;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;159;-1173.177,1114.513;Float;False;Property;_Float4;Smoothness;8;0;Create;False;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;458;-218.9337,2796.345;Float;False;Property;_SparklesBrightness5;Brightness;26;0;Create;False;0;0;0;False;0;False;0;150;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;294;-2280.465,1396.805;Float;False;Property;_ToggleBlur;Toggle Blur;2;1;[Toggle];Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;108;-2746.309,34.84282;Float;False;Property;_OffsetDetail;Offset Detail;15;0;Create;True;0;0;0;False;0;False;1,1;0,0.21;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;109;-2742.496,-135.874;Float;False;Property;_TilingDetail;Tiling Detail;14;0;Create;True;0;0;0;False;0;False;1,1;5,5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;146;-545.4462,2002.875;Inherit;False;Property;_TilingTriplanar;Tiling Triplanar;21;0;Create;True;0;0;0;False;0;False;1,1;0.2,0.2;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;267;-3785.587,1416.607;Float;False;Property;_BlurSize;Blur Size;4;0;Create;True;0;0;0;False;0;False;0;0;0;0.05;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;432;-2149.303,2782.585;Float;True;Property;_SparkleNoiseMap;Sparkle Noise Map;24;2;[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;435;-1872.469,3089.307;Float;False;Property;_Speed;Speed;30;0;Create;True;0;0;0;False;0;False;0.09574114;0.0001;0;0.1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;436;-1873.812,3013.584;Float;False;Property;_Frequency;Frequency;28;0;Create;True;0;0;0;False;0;False;20;8;0;100;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;142;-585.6973,1641.434;Float;True;Property;_CoverageNormal;Coverage Normal;17;3;[NoScaleOffset];[Normal];[SingleLineTexture];Create;True;0;0;0;False;0;False;None;None;True;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;441;-1892.148,2684.976;Float;False;Property;_ScreenContribution;Screen Contribution;32;0;Create;True;0;0;0;False;0;False;0.2;0.67;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;143;-577.0793,2147.427;Float;False;Property;_CoverageFalloff;Coverage Falloff;23;0;Create;True;0;0;0;False;0;False;0.5;5;1;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;138;-1194.136,811.3893;Float;False;Property;_CoverageAmount;Coverage Amount;22;0;Create;True;0;0;0;False;0;False;1;2;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;454;-474.5485,2905.012;Float;False;Property;_SparkleFresnel5;Fresnel Bias, Scale, Power;31;0;Create;False;0;0;0;False;0;False;1,1,1;3,3,3;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;477;-3391.433,2468.977;Float;False;Property;_TransitionFalloff;Transition Falloff;34;0;Create;True;0;0;0;False;0;False;0;10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.AbsOpNode;497;-3357.477,2275.298;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;456;-235.7517,2612.516;Float;False;Property;_SparkleColor5;Color;25;0;Create;False;0;0;0;False;0;False;1,1,1,0;1,1,1,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;233;-1992.929,-211.4644;Inherit;False;231;TileUVs2;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;450;-1024.294,3175.339;Float;False;Property;_Threshold;Threshold;29;0;Create;True;0;0;0;False;0;False;0.5;0.7;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;475;-3803.567,2521.073;Float;False;Property;_TransitionDistance;Transition Distance;33;0;Create;True;0;0;0;False;0;False;0;20;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;452;-1024.294,3255.338;Float;False;Property;_Range;Range;27;0;Create;True;0;0;0;False;0;False;0;0.844;0;1;0;1;FLOAT;0
...
WireConnection;485;0;182;0
WireConnection;485;1;196;0
WireConnection;485;4;183;0
WireConnection;485;6;462;0
WireConnection;485;7;180;0
WireConnection;485;8;178;0
WireConnection;485;11;348;0
ASEEND*/
//CHKSM=96D479BD9C8715E505763CC9DBB259DE07CD1330