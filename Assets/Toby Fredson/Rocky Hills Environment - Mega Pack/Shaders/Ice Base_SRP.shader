...
Shader "Tobyfredson/Ice Base_HDRP"
{
	Properties
	{
		...
		_MetalnessAoGloss("Metalness/Ao/Gloss", 2D) = "white" {}
		[ASEEnd]_Distortion("Distortion", Range( 0 , 1)) = 0.292
		[HideInInspector]_DiffusionProfileAsset("Diffusion Profile", Vector) = ( 0, 0, 0, 0 )
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float3 tex2DNode9 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap ), 1.0f );
				
				float4 screenPos = packedInput.ase_texcoord6;
				float4 ase_grabScreenPos = ASE_ComputeGrabScreenPos( screenPos );
				float4 ase_grabScreenPosNorm = ase_grabScreenPos / ase_grabScreenPos.w;
				float4 fetchOpaqueVal8 = ASEHDSampleSceneColor(( (ase_grabScreenPosNorm).xy + (( tex2DNode9 * _Distortion )).xy ), 0.0, GetInverseCurrentExposureMultiplier());
				
				float2 uv_MetalnessAoGloss = packedInput.ase_texcoord5.xy * _MetalnessAoGloss_ST.xy + _MetalnessAoGloss_ST.zw;
				float4 tex2DNode12 = tex2D( _MetalnessAoGloss, uv_MetalnessAoGloss );
				
				surfaceDescription.Albedo = tex2D( _AlbedoMap, uv_AlbedoMap ).rgb;
				surfaceDescription.Normal = tex2DNode9;
				...
				surfaceDescription.Emission = fetchOpaqueVal8.rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 uv_MetalnessAoGloss = packedInput.ase_texcoord2.xy * _MetalnessAoGloss_ST.xy + _MetalnessAoGloss_ST.zw;
				float4 tex2DNode12 = tex2D( _MetalnessAoGloss, uv_MetalnessAoGloss );
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_MetalnessAoGloss = packedInput.ase_texcoord3.xy * _MetalnessAoGloss_ST.xy + _MetalnessAoGloss_ST.zw;
				float4 tex2DNode12 = tex2D( _MetalnessAoGloss, uv_MetalnessAoGloss );
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_MetalnessAoGloss = packedInput.ase_texcoord7.xy * _MetalnessAoGloss_ST.xy + _MetalnessAoGloss_ST.zw;
				float4 tex2DNode12 = tex2D( _MetalnessAoGloss, uv_MetalnessAoGloss );
...
/*ASEBEGIN
Version=18933
7;288;1906;710;1665.766;252.1488;1.38939;True;True
Node;AmplifyShaderEditor.RangedFloatNode;2;-1336.303,318.3603;Float;False;Property;_Distortion;Distortion;3;0;Create;True;0;0;0;False;0;False;0.292;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GrabScreenPosition;4;-1019.47,98.50877;Inherit;False;0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;10;-470.1525,-191.666;Inherit;True;Property;_AlbedoMap;Albedo Map;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;12;-495.0392,314.6065;Inherit;True;Property;_MetalnessAoGloss;Metalness/Ao/Gloss;2;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DiffusionProfileNode;28;-417.392,507.6895;Float;False;Property;_DiffusionProfile;Diffusion Profile;4;0;Create;True;0;0;0;False;0;False;0;0;True;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;15;1.186226,0;Float;False;True;-1;2;Rendering.HighDefinition.LitShaderGraphGUI;0;2;Tobyfredson/Ice Base_HDRP;53b46d85872c5b24c8f4f0a1c3fe4c87;True;GBuffer;0;0;GBuffer;35;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;5;True;18;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;-25;False;False;False;False;False;False;False;False;False;True;True;0;True;-13;255;False;-1;255;True;-12;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;True;0;True;-14;False;True;1;LightMode=GBuffer;False;False;0;;0;0;Standard;42;Surface Type;1;0;  Rendering Pass;1;0;  Refraction Model;1;0;    Blending Mode;0;0;    Blend Preserves Specular;1;0;  Receive Fog;1;0;  Back Then Front Rendering;0;0;  Transparent Depth Prepass;0;0;  Transparent Depth Postpass;0;0;  Transparent Writes Motion Vector;0;0;  Distortion;0;0;    Distortion Mode;0;0;    Distortion Depth Test;1;0;  ZWrite;0;0;  Z Test;4;0;Double-Sided;0;0;Alpha Clipping;0;0;  Use Shadow Threshold;0;0;Material Type,InvertActionOnDeselection;5;0;  Energy Conserving Specular;1;0;  Transmission;1;0;Receive Decals;1;0;Receives SSR;1;0;Receive SSR Transparent;0;0;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;Specular AA;0;0;Specular Occlusion Mode;0;0;Override Baked GI;0;0;Depth Offset;0;0;DOTS Instancing;1;637780206188746351;LOD CrossFade;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position;1;0;0;12;True;True;True;True;True;True;False;False;False;False;True;True;False;;False;0
...
WireConnection;15;6;8;0
WireConnection;15;7;12;4
WireConnection;15;8;12;2
WireConnection;15;21;28;0
ASEEND*/
//CHKSM=D6EF2D10EFB72344927BB0618A9C171ED0341620