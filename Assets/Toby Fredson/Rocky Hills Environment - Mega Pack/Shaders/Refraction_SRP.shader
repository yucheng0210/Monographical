...
Shader "Tobyfredson/Refraction_HDRP"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[ASEBegin][SingleLineTexture]_AlbedoMap("Albedo Map", 2D) = "white" {}
		_AlbedoColor("Albedo Color", Color) = (0.2113047,0,1,1)
		[SingleLineTexture]_NormalMap("Normal Map", 2D) = "bump" {}
		_Smoothness("Smoothness", Float) = 0
		[SingleLineTexture]_AoMap("Ao Map", 2D) = "white" {}
		[SingleLineTexture]_IridescentMask("Iridescent Mask", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord260 = packedInput.ase_texcoord5.xy * _Tiling + _Offset;
				
				surfaceDescription.Albedo = ( tex2D( _AlbedoMap, texCoord260 ) + _AlbedoColor ).rgb;
				surfaceDescription.Normal = UnpackNormalScale( tex2D( _NormalMap, texCoord260 ), 1.0f );
				...
				surfaceDescription.Occlusion = tex2D( _AoMap, texCoord260 ).g;
				surfaceDescription.Alpha = _AlbedoColor.a;
				...
				#ifdef _MATERIAL_FEATURE_IRIDESCENCE
				surfaceDescription.IridescenceMask = tex2D( _IridescentMask, texCoord260 ).a;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 texCoord260 = packedInput.ase_texcoord2.xy * _Tiling + _Offset;
		...
		Pass
		{
					...
					)
			{
				...
				float2 texCoord260 = packedInput.ase_texcoord3.xy * _Tiling + _Offset;
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 texCoord260 = packedInput.ase_texcoord7.xy * _Tiling + _Offset;
...
/*ASEBEGIN
Version=18933
7;288;1906;710;1661.607;287.9215;1.438748;True;True
Node;AmplifyShaderEditor.CommentaryNode;257;-1173.585,57.72134;Inherit;False;447.4938;374.2796;Comment;3;260;259;258;Tile UVs;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;222;-186.4428,587.8038;Float;True;Property;_RefractionDistance;RefractionDistance;11;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;233;-270.635,810.7914;Inherit;True;Property;_IridescentMask;Iridescent Mask;5;1;[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;b038ed57d601c9449bb1dd51bfbef468;b038ed57d601c9449bb1dd51bfbef468;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;252;51.57035,-355.0524;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;217;-264.9666,-76.49244;Inherit;True;Property;_NormalMap;Normal Map;2;1;[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;302951faffe230848aa0d3df7bb70faa;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;226;-142.5645,135.2501;Float;False;Property;_Smoothness;Smoothness;3;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;225;-127.3175,232.0408;Float;False;Property;_Thickness;Thickness;12;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;264;12.4361,96.18132;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;224;-180.2218,412.1259;Float;False;Property;_RefractionColor;RefractionColor;9;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.9607843,0.8039216,0.9409565,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;223;-164.221,313.9586;Float;False;Property;_RefractionIndex;RefractionIndex;10;0;Create;True;0;0;0;False;0;False;0;0.05;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;231;-190.1326,1017.328;Float;False;Property;_IridescentThickness;IridescentThickness;6;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;204;-181.5416,-256.5673;Float;False;Property;_AlbedoColor;Albedo Color;1;0;Create;True;0;0;0;False;0;False;0.2113047,0,1,1;1,0.8780922,0,0.03529412;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.WireNode;266;-592.9966,-14.51838;Inherit;False;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.WireNode;263;-244.9709,120.4395;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;265;-677.9656,-25.13948;Inherit;False;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;254;-571.759,134.4551;Inherit;True;Property;_AoMap;Ao Map;4;1;[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;260;-948.4669,211.4393;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;259;-1139.403,107.7214;Float;False;Property;_Tiling;Tiling;7;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;258;-1143.216,278.4377;Float;False;Property;_Offset;Offset;8;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SamplerNode;251;-272.6903,-471.7309;Inherit;True;Property;_AlbedoMap;Albedo Map;0;1;[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;240;276.6563,-191.2658;Float;False;True;-1;2;Rendering.HighDefinition.LitShaderGraphGUI;0;2;Tobyfredson/Refraction_HDRP;53b46d85872c5b24c8f4f0a1c3fe4c87;True;GBuffer;0;0;GBuffer;35;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;5;True;18;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;-25;False;False;False;False;False;False;False;False;False;True;True;0;True;-13;255;False;-1;255;True;-12;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;True;0;True;-14;False;True;1;LightMode=GBuffer;False;False;0;;0;0;Standard;42;Surface Type;1;0;  Rendering Pass;1;0;  Refraction Model;2;0;    Blending Mode;0;0;    Blend Preserves Specular;1;0;  Receive Fog;1;0;  Back Then Front Rendering;0;0;  Transparent Depth Prepass;0;0;  Transparent Depth Postpass;0;0;  Transparent Writes Motion Vector;0;0;  Distortion;0;0;    Distortion Mode;0;0;    Distortion Depth Test;1;0;  ZWrite;0;0;  Z Test;4;0;Double-Sided;0;0;Alpha Clipping;0;0;  Use Shadow Threshold;0;0;Material Type,InvertActionOnDeselection;3;0;  Energy Conserving Specular;1;0;  Transmission;1;0;Receive Decals;0;0;Receives SSR;1;0;Receive SSR Transparent;0;0;Motion Vectors;0;0;  Add Precomputed Velocity;0;0;Specular AA;0;0;Specular Occlusion Mode;1;0;Override Baked GI;0;0;Depth Offset;0;0;DOTS Instancing;1;637780207368635438;LOD CrossFade;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position;1;0;0;12;True;True;True;True;True;True;False;False;False;False;True;True;False;;False;0
...
ASEEND*/
//CHKSM=AF458A6F62A3C1EF24F29C5855866F4B6C8A3B47