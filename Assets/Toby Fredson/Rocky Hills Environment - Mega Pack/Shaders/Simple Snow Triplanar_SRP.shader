...
Shader "Tobyfredson/Simple Snow Triplanar_HDRP"
{
	Properties
	{
		...
		_Float6("Smoothness", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float4 triplanar157 = TriplanarSampling157( _Albedo, ase_worldPos, normalWS, 2.0, _TilingTriplanar, 1.0, 0 );
				...
				float3 triplanar151 = TriplanarSampling151( _NormalMap, ase_worldPos, normalWS, 2.0, _TilingTriplanar, 1.0, 0 );
				...
				surfaceDescription.Albedo = triplanar157.xyz;
				surfaceDescription.Normal = tanTriplanarNormal151;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = _Float3;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = 0;
				#endif

				surfaceDescription.Emission = Sparkles469.rgb;
				surfaceDescription.Smoothness = ( triplanar157.a * _Float6 );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 triplanar157 = TriplanarSampling157( _Albedo, ase_worldPos, ase_worldNormal, 2.0, _TilingTriplanar, 1.0, 0 );
				
				float3 ase_worldTangent = packedInput.ase_texcoord4.xyz;
				float3 ase_worldBitangent = packedInput.ase_texcoord5.xyz;
				float3x3 ase_worldToTangent = float3x3(ase_worldTangent,ase_worldBitangent,ase_worldNormal);
				float3 triplanar151 = TriplanarSampling151( _NormalMap, ase_worldPos, ase_worldNormal, 2.0, _TilingTriplanar, 1.0, 0 );
				float3 tanTriplanarNormal151 = mul( ase_worldToTangent, triplanar151 );
		...
		Pass
		{
					...
					)
			{
				...
				surfaceDescription.Normal = tanTriplanarNormal151;
				surfaceDescription.Smoothness = ( triplanar157.w * _Float6 );
				surfaceDescription.Alpha = 1;
		...
		Pass
		{
						...
						)
			{
				...
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float2 uv_SparkleNoiseMap = packedInput.ase_texcoord9.xy * _SparkleNoiseMap_ST.xy + _SparkleNoiseMap_ST.zw;
				float2 temp_output_438_0 = ( uv_SparkleNoiseMap * _Frequency );
				float mulTime439 = _TimeParameters.x * _Speed;
				float smoothstepResult459 = smoothstep( _Threshold , ( _Threshold + _Range ) , ( tex2D( _SparkleNoiseMap, ( ( (ase_screenPosNorm).xy * _ScreenContribution ) + temp_output_438_0 + mulTime439 ) ).g * tex2D( _SparkleNoiseMap, ( ( temp_output_438_0 * 1.1 ) + -mulTime439 ) ).g ));
				float fresnelNdotV457 = dot( normalWS, V );
...
/*ASEBEGIN
Version=18933
7;288;1906;710;1641.231;-630.95;2.221413;True;True
...
Node;AmplifyShaderEditor.CommentaryNode;494;140.2173,2799.458;Inherit;False;1241.161;288.2371;Comment;6;493;490;492;491;488;489;;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;136;-411.3521,522.2073;Inherit;False;1352.758;641.2787;Comment;8;151;142;245;157;244;155;141;146;Triplanar Setup;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;472;-585.1135,2230.26;Inherit;False;1968.271;500.7608;Distance Control;10;482;481;480;478;477;476;475;474;473;507;;1,1,1,1;0;0
Node;AmplifyShaderEditor.TexturePropertyNode;155;-188.5076,575.908;Float;True;Property;_Albedo;Albedo;0;2;[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.WorldPosInputsNode;141;63.32066,782.1061;Float;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.GetLocalVarNode;484;584.4741,1992.766;Inherit;False;482;Distance;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;482;1140.163,2280.261;Float;False;Distance;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ClampOpNode;481;782.8627,2435.358;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;146;-304.8321,789.9855;Inherit;False;Property;_TilingTriplanar;Tiling Triplanar;4;0;Create;True;0;0;0;False;0;False;1,1;0.1,0.1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.TriplanarNode;157;324.4632,583.6446;Inherit;True;Spherical;World;False;Top Texture 0;_TopTexture0;white;-1;None;Mid Texture 0;_MidTexture0;white;0;None;Bot Texture 0;_BotTexture0;white;1;None;Triplanar Sampler;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;1,1;False;4;FLOAT;2;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;486;867.3005,1784.779;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;469;1159.615,1808.679;Inherit;False;Sparkles;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.TexturePropertyNode;142;-164.4307,937.2965;Float;True;Property;_NormalMap;Normal Map;1;3;[NoScaleOffset];[Normal];[SingleLineTexture];Create;True;0;0;0;False;0;False;None;None;True;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;245;720.0938,746.7485;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;508;1000.189,1223.255;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;166;1030.286,1056.383;Float;False;Property;_Float3;Metallic;2;0;Create;False;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;491;907.8877,2954.695;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TriplanarNode;151;354.3242,932.8728;Inherit;True;Spherical;World;True;Top Texture 1;_TopTexture1;white;-1;None;Mid Texture 1;_MidTexture1;white;-1;None;Bot Texture 1;_BotTexture1;white;-1;None;Triplanar Sampler;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;1,1;False;4;FLOAT;2;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;492;706.426,2969.458;Inherit;False;Property;_Strengh;Strengh;17;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;470;1134.307,1136.559;Inherit;False;469;Sparkles;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;489;190.2173,2893.914;Inherit;False;Property;_EdgeDistance;Edge Distance;16;0;Create;True;0;0;0;False;0;False;1;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DepthFade;488;412.4621,2854.591;Inherit;False;True;False;True;2;1;FLOAT3;0,0,0;False;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;493;1138.378,2941.864;Inherit;False;Edgez;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;490;686.426,2849.458;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;244;432.3867,792.3196;Float;False;Property;_Float6;Smoothness;3;0;Create;False;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.DistanceOpNode;476;-226.7301,2364.703;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WorldSpaceCameraPos;473;-535.1138,2469.113;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;464;-27.74722,1897.049;Inherit;False;Constant;_FresnelBias;Fresnel Bias;9;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;475;-220.8558,2557.063;Float;False;Property;_TransitionDistance;Transition Distance;14;0;Create;True;0;0;0;False;0;False;0;25;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;435;-1580.961,1962.08;Float;False;Property;_Speed;Speed;9;0;Create;True;0;0;0;False;0;False;0.09574114;0.0001;0;0.1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;436;-1518.304,1812.357;Float;False;Property;_Frequency;Frequency;10;0;Create;True;0;0;0;False;0;False;20;1.8;0;100;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;432;-1793.795,1581.358;Float;True;Property;_SparkleNoiseMap;Sparkle Noise Map;5;2;[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;False;0;False;None;bdbe94d7623ec3940947b62544306f1c;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;441;-1536.639,1483.749;Float;False;Property;_ScreenContribution;Screen Contribution;12;0;Create;True;0;0;0;False;0;False;0.2;0.941;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.WorldPosInputsNode;474;-528.8528,2294.495;Float;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.WireNode;448;-1254.559,1636.712;Inherit;False;1;0;SAMPLER2D;;False;1;SAMPLER2D;0
Node;AmplifyShaderEditor.PowerNode;480;483.9839,2367.63;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.NegateNode;443;-973.4426,1942.57;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector3Node;454;-119.0386,1703.785;Float;False;Property;_SparkleFresnel5;Fresnel Bias, Scale, Power;13;0;Create;False;0;0;0;False;0;False;1,1,1;3,3,3;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;477;258.6578,2563.923;Float;False;Property;_TransitionFalloff;Transition Falloff;15;0;Create;True;0;0;0;False;0;False;0;-25;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;452;-668.7844,2054.11;Float;False;Property;_Range;Range;8;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;450;-668.7844,1974.112;Float;False;Property;_Threshold;Threshold;11;0;Create;True;0;0;0;False;0;False;0.5;0.654;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;478;42.6995,2370.7;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
WireConnection;507;0;478;0
WireConnection;495;0;157;0
WireConnection;495;1;151;0
WireConnection;495;4;166;0
WireConnection;495;6;470;0
WireConnection;495;7;508;0
ASEEND*/
//CHKSM=34A39D88E9F353DA0A2CE8BDF0E6B635B9255562