...
Shader "Tobyfredson/Standard_HDRP (Tessellation)"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 uv_DisplacementMap = inputMesh.ase_texcoord.xy * _DisplacementMap_ST.xy + _DisplacementMap_ST.zw;
				...
				#endif
				float3 vertexValue = ( ( tex2Dlod( _DisplacementMap, float4( uv_DisplacementMap, 0, 1.0) ) * float4( inputMesh.normalOS , 0.0 ) ) * _DisplacementStrengh ).rgb;
						...
						)
			{
				...
				float2 uv_MetallicAoGloss = packedInput.ase_texcoord5.xy * _MetallicAoGloss_ST.xy + _MetallicAoGloss_ST.zw;
				...
				surfaceDescription.Metallic = ( tex2D( _MetallicMap, uv_MetallicMap ).r * _Metallic );
				...
				surfaceDescription.Smoothness = ( tex2D( _SmoothnessMap, uv_SmoothnessMap ).a * _Smoothness );
				surfaceDescription.Occlusion = pow( abs( tex2D( _MetallicAoGloss, uv_MetallicAoGloss ).g ) , _Ao );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float2 uv_DisplacementMap = inputMesh.uv0.xy * _DisplacementMap_ST.xy + _DisplacementMap_ST.zw;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_AlbedoMap = packedInput.ase_texcoord2.xy * _AlbedoMap_ST.xy + _AlbedoMap_ST.zw;
				...
				float2 uv_MetallicAoGloss = packedInput.ase_texcoord2.xy * _MetallicAoGloss_ST.xy + _MetallicAoGloss_ST.zw;
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_MetallicAoGloss = packedInput.ase_texcoord7.xy * _MetallicAoGloss_ST.xy + _MetallicAoGloss_ST.zw;
...
/*ASEBEGIN
Version=18933
7;383;1906;636;1583.956;-771.428;1;True;True
...
Node;AmplifyShaderEditor.SamplerNode;11;-690.2142,-37.18824;Inherit;True;Property;_NormalMap;Normal Map;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.PowerNode;8;-218.4717,913.2043;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1;-690.3149,402.2376;Float;False;Property;_Metallic;Metallic;3;0;Create;False;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.AbsOpNode;38;-360.7356,884.5736;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;24;-601.4055,1378.89;Float;False;Property;_DisplacementStrengh;Displacement Strengh;9;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;5;-691.6533,1021.934;Float;False;Property;_Ao;Ao;7;0;Create;False;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;3;-697.043,484.8011;Inherit;True;Property;_SmoothnessMap;Smoothness Map;4;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;2;-696.8148,176.8379;Inherit;True;Property;_MetallicMap;Metallic Map;2;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;4;-695.9668,685.2483;Float;False;Property;_Smoothness;Smoothness;5;0;Create;False;0;0;0;False;0;False;0;0.22;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;6;-687.1671,793.2432;Inherit;True;Property;_MetallicAoGloss;Metallic/Ao/Gloss;6;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;25;-936.8733,1153.359;Inherit;True;Property;_DisplacementMap;Displacement Map;8;0;Create;True;0;0;0;False;0;False;-1;None;9789d23040cb1fb45ad60392430c3c15;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;27;4;9;0
WireConnection;27;7;7;0
WireConnection;27;8;8;0
WireConnection;27;11;22;0
ASEEND*/
//CHKSM=CBFB1B34BDAA447B6E693CDE0365E70C93DAFFFA