...
Shader "Tobyfredson/Foliage Coverage_HDRP"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 texCoord25 = inputMesh.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float3 temp_cast_0 = (( inputMesh.ase_color.g * ( pow( abs( ( texCoord25.y * _WindGradient ) ) , ( 1.0 - _WindPower ) ) * simplePerlin2D46 ) )).xxx;
						...
						)
			{
				...
				float2 uv_AoGloss = packedInput.ase_texcoord5.xy * _AoGloss_ST.xy + _AoGloss_ST.zw;
				...
				surfaceDescription.Smoothness = tex2D( _AoGloss, uv_AoGloss ).a;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float2 texCoord25 = inputMesh.uv0.xy * float2( 1,1 ) + float2( 0,0 );
				float3 ase_worldPos = GetAbsolutePositionWS( TransformObjectToWorld( (inputMesh.positionOS).xyz ) );
				float2 appendResult26 = (float2(ase_worldPos.x , ase_worldPos.z));
				float2 appendResult27 = (float2(_TimeParameters.x , _TimeParameters.x));
				float simplePerlin2D46 = snoise( ( appendResult26 + appendResult27 )*_WindScale );
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 uv_AoGloss = packedInput.ase_texcoord2.xy * _AoGloss_ST.xy + _AoGloss_ST.zw;
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_AoGloss = packedInput.ase_texcoord3.xy * _AoGloss_ST.xy + _AoGloss_ST.zw;
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_AoGloss = packedInput.ase_texcoord7.xy * _AoGloss_ST.xy + _AoGloss_ST.zw;
...
/*ASEBEGIN
Version=18933
7;278;1906;642;3361.377;246.8623;2.608459;True;True
Node;AmplifyShaderEditor.CommentaryNode;3;-1647.708,201.4939;Inherit;False;1502.618;737.546;Base Wind;17;63;60;51;46;47;32;40;35;64;37;31;26;27;25;20;19;76;;1,1,1,1;0;0
Node;AmplifyShaderEditor.SamplerNode;13;-580.4375,-603.0591;Inherit;True;Property;_Albedo;Albedo;0;1;[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;63;-450.0878,302.7434;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;77;-544.593,68.2979;Inherit;False;Property;_Cutout;Cutout;1;0;Create;True;0;0;0;False;0;False;0.4;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;56;-574.7726,-140.4724;Inherit;True;Property;_AoGloss;Ao/Gloss;3;1;[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;54;-577.4545,-378.1494;Inherit;True;Property;_Normalmap;Normal map;2;1;[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;51;-687.2179,427.4584;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;46;-932.4958,527.9828;Inherit;True;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;47;-964.7609,270.2582;Inherit;True;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;64;-1100.218,502.2064;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;35;-1122.949,734.9167;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.VertexColorNode;60;-678.0679,239.3704;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;32;-1144.868,600.0045;Inherit;False;Property;_WindScale;Wind Scale;4;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;40;-1318.111,293.1522;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;37;-1374.072,509.9531;Inherit;False;Property;_WindPower;Wind Power;5;0;Create;True;0;0;0;False;0;False;1;2;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;26;-1298.665,691.3296;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.DynamicAppendNode;27;-1327.665,788.3299;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;31;-1591.766,393.5737;Inherit;False;Property;_WindGradient;Wind Gradient;6;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;25;-1544.803,251.4938;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleTimeNode;20;-1575.666,774.3298;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.WorldPosInputsNode;19;-1524.768,609.7366;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.AbsOpNode;76;-1103.553,290.569;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
WireConnection;65;7;56;4
WireConnection;65;9;13;4
WireConnection;65;10;77;0
WireConnection;65;11;63;0
ASEEND*/
//CHKSM=66D5545FE0C63940B8E458C6248283DD62E9C55D