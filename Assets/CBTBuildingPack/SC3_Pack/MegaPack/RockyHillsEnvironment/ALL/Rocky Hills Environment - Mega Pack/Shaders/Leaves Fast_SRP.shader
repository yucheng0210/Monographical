...
Shader "Tobyfredson/Leaves Fast_HDRP"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_Gloss = packedInput.ase_texcoord5.xy * _Gloss_ST.xy + _Gloss_ST.zw;
				...
				surfaceDescription.Smoothness = tex2D( _Gloss, uv_Gloss ).a;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 uv_Gloss = packedInput.ase_texcoord2.xy * _Gloss_ST.xy + _Gloss_ST.zw;
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_Gloss = packedInput.ase_texcoord3.xy * _Gloss_ST.xy + _Gloss_ST.zw;
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_Gloss = packedInput.ase_texcoord7.xy * _Gloss_ST.xy + _Gloss_ST.zw;
...
/*ASEBEGIN
Version=18933
7;288;1906;710;2210.014;71.16451;1.724216;True;True
Node;AmplifyShaderEditor.SamplerNode;11;-512,352;Inherit;True;Property;_Gloss;Gloss;3;1;[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
