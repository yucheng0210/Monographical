...
Shader "Tobyfredson/Tree Bark Foliage Wind"
{
	Properties
	{
		...
		[HDR][NoScaleOffset][Normal][SingleLineTexture]_NormalMap("Normal Map", 2D) = "bump" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float clampResult320 = clamp( inputMesh.positionOS.y , -0.9 , 1.2 );
				float clampResult304 = clamp( inputMesh.positionOS.x , -0.3 , 0.3 );
				float clampResult313 = clamp( inputMesh.positionOS.z , -1.5 , 1.5 );
				float clampResult309 = clamp( ( clampResult320 * ( ( clampResult304 * ( clampResult313 * ( 0.25 * (inputMesh.positionOS).x ) ) ) * 0.002 ) ) , -1.0 , 1.0 );
				float3 temp_cast_0 = (( ( 1.0 * clampResult309 ) * _BranchBending )).xxx;
				float3 _Vector0 = float3(0,0,0);
				float2 temp_cast_1 = (_Vector0.y).xx;
				float3 ase_worldPos = GetAbsolutePositionWS( TransformObjectToWorld( (inputMesh.positionOS).xyz ) );
				float4 localWorldVar138 = float4( ase_worldPos , 0.0 );
				(localWorldVar138).xyz = GetCameraRelativePositionWS((localWorldVar138).xyz);
				float4 transform138 = mul(GetWorldToObjectMatrix(),localWorldVar138);
				float2 appendResult128 = (float2(( ( inputMesh.positionOS.y * cos( ( ( ( transform138.x + transform138.z ) * _WorldFrequency ) + ( _TimeParameters.x ) ) ) ) * _BendAmount ) , _Vector0.y));
				float normalizeResult154 = normalize( transform138.y );
				float clampResult163 = clamp( ( normalizeResult154 * 10.0 ) , 10.0 , 10.0 );
						...
						)
			{
				...
				float2 texCoord7 = packedInput.ase_texcoord5.xy * _Tiling + _Offset;
				float2 TileUVs9 = texCoord7;
				
				float4 tex2DNode32 = tex2D( _MaskMap, TileUVs9 );
				
				float temp_output_59_0 = pow( abs( tex2DNode32.g ) , _Float6 );
				float blendOpSrc103 = packedInput.ase_color.r;
				...
				surfaceDescription.Albedo = tex2D( _AlbedoMap, TileUVs9 ).rgb;
				surfaceDescription.Normal = UnpackNormalScale( tex2D( _NormalMap, TileUVs9 ), 1.0f );
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = ( tex2DNode32.r * _Float4 );
				...
				surfaceDescription.Smoothness = ( tex2DNode32.a * _Float5 );
				surfaceDescription.Occlusion = staticSwitch105;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 texCoord7 = packedInput.ase_texcoord2.xy * _Tiling + _Offset;
				float2 TileUVs9 = texCoord7;
		...
		Pass
		{
					...
					)
			{
				...
				float2 texCoord7 = packedInput.ase_texcoord3.xy * _Tiling + _Offset;
				float2 TileUVs9 = texCoord7;
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 texCoord7 = packedInput.ase_texcoord7.xy * _Tiling + _Offset;
				float2 TileUVs9 = texCoord7;
...
/*ASEBEGIN
Version=18933
0;672;1906;971;1934.078;-85.3132;1;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;111;-2620.163,1628.385;Inherit;False;Property;_WorldFrequency;World Frequency;10;0;Create;True;0;0;0;False;0;False;1;0.08;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;121;-1828.773,1798.859;Inherit;False;Property;_BendAmount;Bend Amount;12;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ClampOpNode;163;-1069.635,1371.368;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;10;False;2;FLOAT;10;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;316;-568.375,2784.243;Inherit;False;Property;_BranchBending;Branch Bending;13;0;Create;True;0;0;0;False;0;False;1;1;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;129;-807.4576,1365.87;Inherit;False;Property;_WindDirection;Wind Direction;11;0;Create;True;0;0;0;False;0;False;1;1.5678;1.54;1.6;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;39;-1368.731,411.3753;Float;False;Property;_Float5;Smoothness;5;0;Create;False;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;32;-1383.288,197.0916;Inherit;True;Property;_MaskMap;Mask Map;2;2;[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;101;-927.3311,1126.317;Inherit;False;Property;_VertexAointensity;Vertex Ao intensity;9;0;Create;True;0;0;0;False;0;False;0;0.4;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;102;-818.4333,938.6047;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;6;-2091.473,518.6396;Float;False;Property;_Offset;Offset;7;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.AbsOpNode;346;-1131.078,459.3132;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;141;-1370.648,609.5497;Float;False;Property;_Float4;Metallic;4;0;Create;False;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;53;-1371.808,514.1867;Float;False;Property;_Float6;Ambient Occlusion;3;0;Create;False;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;105;-415.2456,944.1715;Inherit;False;Property;_VertexAoOnOff;Vertex Ao (On/Off);8;0;Create;True;0;0;0;False;0;False;0;1;1;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
WireConnection;59;0;346;0
WireConnection;59;1;53;0
WireConnection;31;1;13;0
WireConnection;346;0;32;2
...
WireConnection;334;0;31;0
WireConnection;334;1;19;0
WireConnection;334;4;140;0
WireConnection;334;7;42;0
WireConnection;334;8;105;0
WireConnection;334;11;130;0
ASEEND*/
//CHKSM=45B9A4169C79B1950B06CE6A184B59E1B2D7CEF3