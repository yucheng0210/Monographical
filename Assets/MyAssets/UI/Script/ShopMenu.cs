...
public class ShopMenu : UIBase
{
    ...
    protected override void Update()
    {
        ...
        if (shopDialog.OpenMenu && !OpenBool)
        {
            ...
            UIManager.Instance.RefreshItem(backpackSlot, slotGroupTrans, DataManager.Instance.ShopBag);
            UpdateItemInfo("", "");
        }
    }
    ...
    public void Business(Item item)
    {
        ...
        else
        {
            ...
            UIManager.Instance.RefreshItem(backpackSlot, slotGroupTrans, DataManager.Instance.Backpack);
        }
    }
